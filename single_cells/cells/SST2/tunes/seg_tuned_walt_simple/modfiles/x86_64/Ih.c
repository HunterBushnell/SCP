...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ih /home/hrbncv/PV-SST/single_cells/cells/SST2/tunes/seg_tuned_walt_simple/modfiles/Ih.mod\n");
...
static int  rates ( _threadargsproto_ ) {
    mAlpha = 0.001 * 6.43 * vtrap ( _threadargscomma_ v + 127.0 , 5.9 ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/hrbncv/PV-SST/single_cells/cells/SST2/tunes/seg_tuned_walt_simple/modfiles/Ih.mod";
static const char* nmodl_file_text = 
  ...
  "		mAlpha = 0.001 * 6.43 * vtrap(v + 127, 5.9)\n"
